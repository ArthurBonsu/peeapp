...
export interface FileTokenUpgradeableInterface extends utils.Interface {
  functions: {
    ...
    "fileidset(address)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "fileidset", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "increaseAllowance",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "TransferFrom(address,address,uint256)": EventFragment;
  };
...
export interface FileTokenUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FileTokenUpgradeableInterface;
