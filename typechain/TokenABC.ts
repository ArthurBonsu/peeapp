...
export interface TokenABCInterface extends utils.Interface {
  contractName: "TokenABC";
  functions: {
...
export interface TokenABC extends BaseContract {
  contractName: "TokenABC";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenABCInterface;
