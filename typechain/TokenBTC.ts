...
export interface TokenBTCInterface extends utils.Interface {
  contractName: "TokenBTC";
  functions: {
...
export interface TokenBTC extends BaseContract {
  contractName: "TokenBTC";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenBTCInterface;
