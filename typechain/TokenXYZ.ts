...
export interface TokenXYZInterface extends utils.Interface {
  contractName: "TokenXYZ";
  functions: {
...
export interface TokenXYZ extends BaseContract {
  contractName: "TokenXYZ";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenXYZInterface;
